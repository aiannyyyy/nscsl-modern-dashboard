...
import { CumulativePerProvince } from "./components/ReceivedCumulativePerProvince";
import { MonthlyTotalSamples } from "./components/ReceivedMonthlyTotalSamples";

export const SampleReceived: React.FC = () => {
